...
export const moduleQualifications = {
	...
	actions: { 
		...
		async update_qualification({commit, state, rootGetters, rootState}, object_qualification) {
			await axios.put(
				rootGetters.get_url_api(state.url_api_qualifications, object_qualification.id_mturk),
		...
		async add_qualification({commit, state, rootGetters, rootState}, object_qualification) {
			await axios.post(
		...
		async delete_qualifications({commit, state, rootGetters, rootState}, list_qualifications) {

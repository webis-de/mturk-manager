...
class Class_Service_Templates {
    async load_all(project=store.getters['moduleProjects/get_project_current'])
    {
    ...
    async load(type_template, project=store.getters['moduleProjects/get_project_current'])
    {
    ...
    async edit({type_template, template_current, template_new, project})
    {
    ...
    async delete({type_template, template, project, callback}) {

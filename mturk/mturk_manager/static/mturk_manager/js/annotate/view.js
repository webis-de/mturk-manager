...
export default class View {
  ...
  inject_templates() {
    ...
    let object_assignments_grouped_by_batch = _.groupBy(
          ...
          _.forEach(object_grouped_by_hits, (grouped_by_hits, id_hit) => {
            ...
            _.forEach(grouped_by_hits, assignment => {
              ...
              if (is_table === true) {
                ...
                const index_row = _.findIndex(wrapper_assignment, e => {
                  return e.tagName === "TR";
                });

                wrapper_assignment[index_row].dataset.id_assignment =
                  assignment.id;
                $(wrapper_assignment[index_row]).data("assignment", assignment);

                const index_script = _.findIndex(wrapper_assignment, e => {
